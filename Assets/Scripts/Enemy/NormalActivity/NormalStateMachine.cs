...
public class NormalStateMachine : StateMachine
{
    ...
    public NormalRunState runState;

    public NormalRangeAttackState rangeAttackState;
    ...
    private void Awake()
    {
        runState = new NormalRunState(this);
        rangeAttackState = new NormalRangeAttackState(this);
