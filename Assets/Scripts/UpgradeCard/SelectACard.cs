...
public class SelectACard : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        button.onClick.AddListener(() => openChestSystem.SelectACard(gameObject.transform.parent.GetComponent<CardData>().upgradeCardData));
    }
